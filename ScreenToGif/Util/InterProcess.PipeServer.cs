...
namespace ScreenToGif.Util
{
    ...
    {
        private class PipeServer<TMessage>
        {
            ...
            public PipeServer(string pipeName)
            {
                ...
                _ = Task.Run(() => ServerLoop())
                    .ContinueWith(t => OnServerError(t.Exception), default, TaskContinuationOptions.OnlyOnFaulted, TaskScheduler.FromCurrentSynchronizationContext());
            }
            ...
            private async void ServerLoop()
            {
                while (true)
                {
                    ...
                    var message = await JsonSerializer.DeserializeAsync<TMessage>(_pipe, null, _source.Token);
